...
test("chaque page contient exactement une instance de Claire", async () => {
  for (const page of pages) {
    ...
    assert.equal(matches(html, /href="(assets\/css\/claire-companion\.css\?v=20260902-it20)"/g).length, 1, page);
    assert.equal(matches(html, /src="(assets\/js\/claire-companion\.js\?v=20260902-it20)"/g).length, 1, page);
...
test("Claire accueille l'utilisateur et explique son rôle chez InfoServ2A", async () => {
  ...
  assert.match(endpoint, /InfoServ2A Claire Aidant 1\.19/);
