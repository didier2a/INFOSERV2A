import { adjacentPage, adjacentSection, catalogEntries, currentPage, pageById, scorePage } from "./claire-core.mjs?v=20260912-pip-edge-v1";
import {
...
import { validateContactFields, validateQuoteFields } from "./form-schema.mjs?v=20260912-pip-edge-v1";
