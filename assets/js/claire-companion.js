...
} from "./site-email.mjs?v=20260912-claire-mobile-option-2-v1";
import {
  ...
  reduceMobileScene,
  sceneStatusLabel
} from "./claire-mobile-scene.mjs?v=20260912-claire-mobile-option-2-v1";
import { resolveInitialClaireState } from "./claire-entry-mode.mjs?v=20260912-claire-mobile-option-2-v1";
...
} from "./claire-site-runtime-adapter.mjs?v=20260912-claire-mobile-option-2-v1";
import "./contact.js?v=20260912-claire-mobile-option-2-v1";
import "./devis.js?v=20260912-claire-mobile-option-2-v1";
...
const KNOWLEDGE_URL = "data/site-knowledge.json?v=20260912-claire-mobile-option-2-v1";
const CAPABILITIES_URL = "data/claire-capabilities.json?v=20260912-claire-mobile-option-2-v1";
...
export class ClaireCompanion {
  ...
  cacheNodes() {
    ...
    this.nodes = {
      choice: find(".claire-mobile-choice"),
  ...
  setState(next) {
    ...
    this.nodes.choice?.setAttribute("aria-hidden", next === "choice" ? "false" : "true");
    ...
    if (next === "choice") {
      ...
      requestAnimationFrame(() => this.root.querySelector("[data-claire-choice-primary]")?.focus({ preventScroll: true }));
  ...
  async configureLiveAvatarProvider() {
    ...
    try {
      ...
      const { InfoServ2ALiveAvatarProvider } = await import("./claire-liveavatar-provider.js?v=20260912-claire-mobile-option-2-v1");
