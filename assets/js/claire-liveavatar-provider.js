import { isInternalSitePrompt, isStableUrgentCommand, isUrgentSiteCommand, isClaireQuotePrompt } from "./claire-core.mjs?v=20260904-it35";
...
export class InfoServ2ALiveAvatarProvider {
  ...
  sendPrompt(value) {
    ...
    if (sent === "queued" || sent === "dropped") {
      this.emit("thinking", sent === "dropped" ? "Page affichée · Claire continue" : "Claire termine sa phrase…");
      return true;
    }
    this.armReplyTimer();
